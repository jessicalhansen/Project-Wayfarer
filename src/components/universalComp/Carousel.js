		...
		<div className="carousel relative shadow-2xl bg-white">
			<div className="carousel-inner relative overflow-hidden w-full">
				...
				>
					<div
						id="Slide1"
						className="block h-full w-full bg-indigo-500 text-white text-5xl text-center"
					>
						{/* Slide 1 */}
					</div>
				</div>
				...
				>
					<div className="block h-full w-full bg-orange-500 text-white text-5xl text-center">
						...
						{/* <img
							id="Slide2"
							src="'https://i2.wp.com/handluggageonly.co.uk/wp-content/uploads/2014/09/Rio-de-Janeiro-s.jpg?w=1600&ssl=1'"
							alt="Reo"
						/> */}
					</div>
				</div>
				...
				>
					<div
						id="Slide3"
						className="block h-full w-full bg-green-500 text-white text-5xl text-center"
					>
						{/* Slide 3 */}
					</div>
				</div>
